...
public class BluePruevba extends SequentialCommandGroup {
    ...
    public BluePruevba(MecanumDriveTrain m_drive, Shooter m_shooter, Intake m_intake, Torreta m_torreta, Feeder m_feeder,Telemetry tl){
