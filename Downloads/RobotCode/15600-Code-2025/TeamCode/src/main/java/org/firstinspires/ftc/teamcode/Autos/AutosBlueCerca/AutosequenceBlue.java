...
public AutosequenceBlue(MecanumDriveTrain m_drive, Shooter m_shooter, Intake m_intake, Torreta m_torreta, Feeder m_feeder, Telemetry tl, AprilTagDetection tagDetectado){
...
new SequentialCommandGroup(
       ...
       new InstantCommand(()->m_feeder.setInitialColor(0,m_feeder.sensor1Color())),
        ...
        new PathCommand(m_drive, PathsBlue.Shoot1),//Posicion disparo
                ...
                new WaitCommand(300),
                new SmartShootCommandBLue(m_drive, m_shooter, m_feeder, tl,true,3050, tagDetectado.id),
...
new ParallelCommandGroup(
    ...
    new ParallelCommandGroup(
        ...
        new InstantCommand(()-> m_intake.setPower(0)),
            new SmartShootCommandBLue(m_drive, m_shooter, m_feeder, tl,true, 3050, tagDetectado.id),//Dispara segunda ronda
            new WaitCommand(500),
