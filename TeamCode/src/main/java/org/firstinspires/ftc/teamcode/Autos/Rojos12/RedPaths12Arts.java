...
public class RedPaths12Arts {
    ...
    public RedPaths12Arts(Follower follower) {
        Shoot0 = follower
                .pathBuilder()
                .addPath(
        ...
        Shoot2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(134.769, 61.631), new Pose(104.862, 103.569))
                )
        ...
        PreIntake3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(104.862, 103.569), new Pose(106.338, 38.631))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        PosIntake3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(106.338, 38.631), new Pose(135.323, 38.631))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        Shoot3 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(135.323, 38.631), new Pose(99, 114.985))
                )
