...
import org.firstinspires.ftc.teamcode.Robot.Subsystems.NewTurretTest;
...
public class GoToTargetTurret extends CommandBase {
    ...
    public GoToTargetTurret(NewTurretTest m_turret, MecanumDriveTrain m_drive, Telemetry telemetry, boolean isBlueAlliance){
        ...
        if (isBlueAlliance) {//BLUE
            this.targetPose = new Pose(15, 134);
        } else {//RED
