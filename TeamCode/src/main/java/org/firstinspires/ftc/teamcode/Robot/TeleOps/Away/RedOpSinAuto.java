...
@TeleOp(name = "RedOpSinAutoAway", group = "Away")
public class RedOpSinAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_torreta.setDefaultCommand(new TorretaCommand(m_driveTrain, m_torreta, telemetry, new Pose2d(144, 137, Math.toRadians(0))));
